...
| Sync time from Home Assistant | Button | Sets the appliance's own clock to Home Assistant's local time - useful for appliances with no cloud connection, and it keeps DST changes right |
