...
| Sync time from Home Assistant | Button | Sets the appliance's own clock to Home Assistant's local time - useful for appliances without internet access, and it keeps DST changes right |
